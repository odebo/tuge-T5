...
public class WheelView extends View {
    ...
    public WheelView(Context context, AttributeSet attrs) {
        ...
        if (attrs != null) {
            ...
            textColorOut = a.getColor(R.styleable.pickerview_wheelview_textColorOut, 0xFF888888);
            textColorCenter = a.getColor(R.styleable.pickerview_wheelview_textColorCenter, 0xFFCCCCCC);
